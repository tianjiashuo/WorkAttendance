...
public class PowerDao {
    ...
    public boolean queryViewOwnAttendancePowerById(int powerId) {
        String sql = "SELECT `view_own_attendance` FROM power WHERE positionId=? ";
    ...
    public boolean queryViewAllAttendancePowerById(int powerId) {
        String sql = "SELECT `view_all_attendance` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryViewCheckPowerById(int powerId) {
        String sql = "SELECT `view_check` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryViewAllLeavePowerById(int powerId) {
        String sql = "SELECT `view_all_leave` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryViewPassLeavePowerById(int powerId) {
        String sql = "SELECT `view_pass_leave` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryViewAllGooutPowerById(int powerId) {
        String sql = "SELECT `view_all_goout` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryViewPassGooutPowerById(int powerId) {
        String sql = "SELECT `view_pass_goout` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean querySetAnnualGooutPowerById(int powerId) {
        String sql = "SELECT `set_annual_goout` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean querySetLeaveTypesPowerById(int powerId) {
        String sql = "SELECT `set_leave_types` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryLeaveApprovalPowerById(int powerId) {
        String sql = "SELECT `leave_approval` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }

    public boolean queryGooutApprovalPowerById(int powerId) {
        String sql = "SELECT `goout_approval` FROM power WHERE positionId=? ";
        return jdbcTemplate.queryForObject(sql, new Object[]{powerId}, Boolean.class);
    }
}
